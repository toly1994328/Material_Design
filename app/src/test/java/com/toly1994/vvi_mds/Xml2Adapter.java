...
public class Xml2Adapter {
    ...
    public void main() {
        //你的布局xml所在路径
        File file = new File("I:\\Java\\Android\\APL\\VVI_MDs\\app\\src\\main\\res\\layout\\item_of_base.xml");
        //你的Adapter的java类放在哪个包里
        File out = new File("I:\\Java\\Android\\APL\\VVI_MDs\\app\\src\\main\\java\\com\\toly1994\\vvi_mds\\appbar");
        //你的Adapter的名字--不要加.java
        String name = "ACAdapter";
