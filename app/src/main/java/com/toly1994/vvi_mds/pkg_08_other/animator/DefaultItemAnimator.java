 ...
 */
package com.toly1994.vvi_mds.pkg_08_other.animator;
...
import com.toly1994.vvi_mds.pkg_08_other.adapter.MyViewHolder;
...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public boolean animateAdd(final ViewHolder holder) {
        ...
        Log.e(TAG, "animateAdd: " + myViewHolder.mItemTV.getText().toString());
    ...
    public boolean animateMove(final ViewHolder holder, int fromX, int fromY,
                               int toX, int toY) {
        MyViewHolder myViewHolder = (MyViewHolder) holder;
        Log.e(TAG, "animateMove: " + myViewHolder.mItemTV.getText().toString());
        final View view = holder.itemView;
